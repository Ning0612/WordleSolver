...
The current strategy solves 2,271 of 2,309 benchmark entries. Of the 38 failures,
9 are not present in `data/five_letter_words.txt`, leaving 29 failures against
answers that are representable by the solver dictionary.
